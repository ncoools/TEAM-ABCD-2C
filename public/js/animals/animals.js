...
$(document).on('click', '.edit-btn', function () {
   ...
   $.ajax({
    url: baseUrl + 'animals/edit/' + userId,
    method: 'GET',
    dataType: 'json',
    success: function (response) {
        if (response.data) {
            ...
            $('#editUserModal #classes').val(response.data.classes);
...
$(document).on('click', '.deleteUserBtn', function () {
    ...
    if (confirm('Are you sure you want to delete this animal?')) {
        $.ajax({
            url: baseUrl + 'animals/delete/' + userId,
            method: 'POST', 
            data: {
                _method: 'DELETE',
                [csrfName]: csrfToken
...
$(document).ready(function () {
    ...
    $table.DataTable({
        ...
        serverSide: true,
        ajax: {
            url: baseUrl + 'animals/fetchRecords',
            type: 'POST',
            headers: {
